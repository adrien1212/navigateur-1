...
Cette partie présente simplement le découpage de l'application en package. Nous détaillerons le contenu de certain packages dans les sections suivantes (\ref{choix_conception}).
...
\draw[->] (APP.south) |- ++(0, -0.5) -- ++(-8,0) --node[above , sloped ,black]{}  +(0 ,1)  |- (DB.west);
