...
D'autres choix de conception serons présentés dans la section \textit{\nameref{choix_conception}}
...
\association{HistoryController}{table}{1}{TableHistory}{}{}
...
\begin{center}
\begin{tikzpicture}
\begin{interface}[text  width=4.5cm]{ConfigurationFile}{0,-0.7}
\operation {+ load() }
\operation {+ save() }
\end{interface}	
